...
//}
//
//QVariant ItemGridModel::headerData(int section, Qt::Orientation orientation, int role) const
//{
//    if (role != Qt::DisplayRole)
//    {
//        qDebug("Bad Role");
...
//}
//
//int ItemGridModel::columnCount(const QModelIndex& parent) const
//{
//    //return List.count(); /** only 1-Dimensional */
//    return parent.row(); /** only 1-Dimensional */
//}
//
//QModelIndex ItemGridModel::parent(const QModelIndex& index) const
//{
//    if (!index.isValid())
//    {
...
//QModelIndex ItemGridModel::index(int row, int column, const QModelIndex& parent) const
//{
